...
type Querier interface {
	...
	CoreUserScheduledMessageCreate(ctx context.Context, arg CoreUserScheduledMessageCreateParams) (CoreUserScheduledMessage, error)
	CoreUserScheduledMessageDelete(ctx context.Context, id int32) (CoreUserScheduledMessage, error)
	CoreUserScheduledMessageGetByUserID(ctx context.Context, userID uuid.UUID) ([]CoreUserScheduledMessage, error)
	CoreUserScheduledMessageGetOne(ctx context.Context, id int32) (CoreUserScheduledMessage, error)
	CoreUserScheduledMessageUpdate(ctx context.Context, arg CoreUserScheduledMessageUpdateParams) (CoreUserScheduledMessage, error)
	...
	KickDefaultBotUpdate(ctx context.Context, botID string) (int64, error)
	KickDefaultBroadcasterGet(ctx context.Context) (string, error)
	KickDefaultBroadcasterUpdate(ctx context.Context, broadcasterID string) (int64, error)
